        ...
        if "data" in feed_list and "list" in feed_list["data"]:
            ...
            for feed in first_six_feeds:
                if "id" in feed:  # Check if "id" exists in the feed
                    ...
                    print(f"Posted Comment on Feed {feed_id}: {comment_result}")
        ...
        if "data" in feed_list and "list" in feed_list["data"]:
            ...
            for feed in first_three_feeds:
                if "id" in feed:  # Check if "id" exists in the feed
                    ...
                    print(f"Reposted Feed {repost_feed_id}: {repost_result}")
